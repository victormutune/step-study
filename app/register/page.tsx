...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (result.success) {
        // Check if redirected from research page
        const redirectedFromChart = typeof window !== "undefined" ? sessionStorage.getItem("redirectedFromChart") : null

        if (redirectedFromChart) {
